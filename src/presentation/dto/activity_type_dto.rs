//! ActivityType DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new ActivityType
///
...
/// Request DTO for full update of a ActivityType
///
...
/// Request DTO for partial update of a ActivityType
///
...
/// Response DTO for ActivityType entity
///
...
/// Paginated list response for ActivityType entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ActivityTypeListResponseDto {
    /// List of items
    pub items: Vec<ActivityTypeResponseDto>,
...
impl ActivityTypeListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<ActivityTypeResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<ActivityType> for ActivityTypeResponseDto {
...
impl From<ActivityType> for ActivityTypeSummaryDto {
    fn from(entity: ActivityType) -> Self {
...
impl From<CreateActivityTypeDto> for ActivityType {
...
impl backbone_core::FromCreateDto<CreateActivityTypeDto> for ActivityType {
    fn from_create_dto(dto: CreateActivityTypeDto) -> backbone_core::ServiceResult<Self> {
        Ok(ActivityType::from(dto))
    }
}
