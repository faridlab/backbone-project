...
impl PatchTimesheetDetailDto {
    ...
    pub fn has_changes(&self) -> bool {
        self.company_id.is_some() || self.timesheet_id.is_some() || self.activity_type_id.is_some() || self.task_id.is_some() || self.description.is_some() || self.hours.is_some() || self.billing_rate.is_some() || self.costing_rate.is_some() || self.is_billable.is_some() || self.billable_amount.is_some() || self.costing_amount.is_some()
    }
}
