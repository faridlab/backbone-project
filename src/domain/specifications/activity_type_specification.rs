//! Specifications for ActivityType aggregate
//!
...
// Each predicate implements `Specification<ActivityType>` and can be combined
...
//
// pub struct ActiveActivityTypeSpec;
// impl Specification<ActivityType> for ActiveActivityTypeSpec {
//     fn is_satisfied_by(&self, e: &ActivityType) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
