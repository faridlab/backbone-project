//! Specifications for ProjectTemplate aggregate
//!
...
// Each predicate implements `Specification<ProjectTemplate>` and can be combined
...
//
// pub struct ActiveProjectTemplateSpec;
// impl Specification<ProjectTemplate> for ActiveProjectTemplateSpec {
//     fn is_satisfied_by(&self, e: &ProjectTemplate) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
