//! Specifications for Project aggregate
//!
...
// Each predicate implements `Specification<Project>` and can be combined
...
//
// pub struct ActiveProjectSpec;
// impl Specification<Project> for ActiveProjectSpec {
//     fn is_satisfied_by(&self, e: &Project) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
