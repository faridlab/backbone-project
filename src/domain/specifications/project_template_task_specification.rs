//! Specifications for ProjectTemplateTask aggregate
//!
...
// Each predicate implements `Specification<ProjectTemplateTask>` and can be combined
...
//
// pub struct ActiveProjectTemplateTaskSpec;
// impl Specification<ProjectTemplateTask> for ActiveProjectTemplateTaskSpec {
//     fn is_satisfied_by(&self, e: &ProjectTemplateTask) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
