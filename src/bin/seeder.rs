//! Database seeder binary for module: project
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin project-seeder
//! Or via CLI: backbone seed run --module project
//!
...
// Import seeders
use backbone_project::seeders::SeedActivityTypeSeeder;
use backbone_project::seeders::SeedProjectSeeder;
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: project");
    println!();

    // Register seeders in order
    let mut seeders: Vec<Box<dyn Seeder + Send + Sync>> = Vec::new();
    seeders.push(Box::new(SeedActivityTypeSeeder::new()));
    seeders.push(Box::new(SeedProjectSeeder::new()));
