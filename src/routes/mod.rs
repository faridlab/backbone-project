...
/// Create stateless routes for the Project module.
///
...
///
/// ```ignore
/// let module = ProjectModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::ProjectModule) -> Router<()> {
    Router::new()
        ...
        .merge(create_project_template_task_routes(module.project_template_task_service.clone()))
...
pub fn get_routes(module: &crate::ProjectModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Project module.
///
...
pub fn create_combined_routes(module: &crate::ProjectModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Project module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::ProjectModule) -> Router<AppState> {
    Router::new()
